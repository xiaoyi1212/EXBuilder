...
public class BasicParser {
    ...
    public BasicParser(LinkedList<LexToken.TokenD> tds, VMOutputStream player){
        this.index = 0;
        this.tds = tds;
        this.player = player;
    }
    ...
    public VMloader rust(String file_name,VMOutputStream player) throws VMException, VMRuntimeException {
        AstLeaf leaf;
