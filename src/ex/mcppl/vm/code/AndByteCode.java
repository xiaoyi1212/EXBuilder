...
public class AndByteCode implements ByteCode{
    ...
    public void exe(Executor executor) throws VMRuntimeException {
        ...
        }else throw new VMRuntimeException("Cannot convert other types to Boolean types.", executor.getPlayer());
        ...
        if(!obj1.getType().equals(ExObject.Type.BOOL))throw new VMRuntimeException("Cannot convert other types to Boolean types.", executor.getPlayer());
